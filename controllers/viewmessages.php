 ...
 {  
    ...
    $query = "SELECT chat.id,customer_id,message,user_type,customers.first_name,customers.middle_name,customers.last_name FROM chat INNER JOIN customers ON customer_id = customers.id WHERE customer_id='$id' AND store='$Store_name'";
